            ...
            <div>
                <div className="px-10">
                    ...
                    <div className="text-slate-400">
                        {type === "signin" ? "Dont't have an account?" : "Already have an acccount?"}
                ...
                <div className="pt-4">
                    {type === "signup" ? <LabelledInput label="Name" placeholder="Antriksh Guleria" onChange={(e) => {
                        setPostInput({
                            ...postInputs,
                            name: e.target.value
                        })
                    }} /> : null}
                    <LabelledInput label="email" placeholder="Antriksh@gmail.com" onChange={(e) => {
                        setPostInput({
                            ...postInputs,
